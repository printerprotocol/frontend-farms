...
import { Modal, Button, Flex, LinkExternal } from 'printersharesfinance-uikit'
...
const ContributeModal: React.FC<Props> = ({ currency, contract, currencyAddress, onDismiss }) => {
  ...
  return (
    <Modal title={`Contribute ${currency}`} onDismiss={onDismiss}>
      ...
      <LinkExternal
        href="https://exchange.printershares.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82"
        style={{ margin: 'auto' }}
      >
        {`Get ${currency}`}
      </LinkExternal>
